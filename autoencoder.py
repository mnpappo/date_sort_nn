...
x = Convolution2D(16, kernel, kernel, activation='relu', border_mode='same', name="c2")(x)
x = MaxPooling2D((2, 2), border_mode='same')(x)
...
x = Convolution2D(16, kernel, kernel, activation='relu', border_mode='same', name="c5")(x)
x = UpSampling2D((2, 2))(x)
x = Convolution2D(32, kernel, kernel, activation='relu', border_mode='same', name="c6")(x)
x = UpSampling2D((2, 2))(x)
decoded = Convolution2D(1, kernel, kernel, activation='sigmoid', border_mode='same', name="c7")(x)
...
with open("localizing_grayx.json", "w") as json_file:
    json_file.write(model_json)

autoencoder.save_weights('localizing_grayx.h5')
